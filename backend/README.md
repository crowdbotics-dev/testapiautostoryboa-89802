...
## Project Structure
    ...
    ├── testapiautostoryboa_89802  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_89802`
...
2. Clone this repo and `cd testapiautostoryboa_89802`
